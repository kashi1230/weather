import 'dart:convert';
/// coord : {"lon":77.7642,"lat":22.6079}
/// weather : [{"id":800,"main":"Clear","description":"clear sky","icon":"01n"}]
/// base : "stations"
/// main : {"temp":296.44,"feels_like":295.87,"temp_min":296.44,"temp_max":296.44,"pressure":1014,"humidity":40,"sea_level":1014,"grnd_level":977}
/// visibility : 10000
/// wind : {"speed":2.75,"deg":31,"gust":2.79}
/// clouds : {"all":0}
/// dt : 1700914913
/// sys : {"country":"IN","sunrise":1700874489,"sunset":1700913823}
/// timezone : 19800
/// id : 1269653
/// name : "Itārsi"
/// cod : 200

CurrentWhetherData currentWhetherDataFromJson(String str) => CurrentWhetherData.fromJson(json.decode(str));
String currentWhetherDataToJson(CurrentWhetherData data) => json.encode(data.toJson());
class CurrentWhetherData {
  CurrentWhetherData({
      Coord? coord, 
  ...
  CurrentWhetherData.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
CurrentWhetherData copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => CurrentWhetherData(  coord: coord ?? _coord,
